...
- Name: products.spec.ts >> Product Management E2E >> should display products page with header and controls
- Location: tests/e2e/products.spec.ts:11:7
...
Error: strict mode violation: locator('h1') resolved to 2 elements:
    1) <h1 class="text-lg font-bold text-orange-500">1ai-reach</h1> aka getByRole('heading', { name: '1ai-reach' })
    2) <h1 class="next-error-h1">404</h1> aka getByRole('heading', { name: '404' })
