...
- Name: products.spec.ts >> Product Management E2E >> should import products from CSV file
- Location: tests/e2e/products.spec.ts:145:7
...
Call log:
  - waiting for getByRole('button', { name: /Import CSV/i })
